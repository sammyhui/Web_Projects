...
<body>
    ...
    <header class="header">
        ...
        <div class="menu">
            <a href="checkout.php"><i class="fas fa-shopping-cart"></i> Keranjang</a>
            <a href="upload_sewa.php"><i class="fas fa-user"></i> Akun</a>
            <a href="upload.php"><i class="fas fa-bars"></i> Menu</a>
        </div>
...
<section class="hero">
  ...
  <div class="hero-text">
      <p class="greeting">BELANJA & JUALAN? LANGSUNG AJA DI SINI!</p>
      <h1>WELCOME</h1>
      <p class="desc">marketplace khusus mahasiswa, cepat, aman sesama anak kampus</p>
  </div>
  ...
  <div class="event-section">
    ...
    <div class="event-container">
         <div class="event-card">
            ...
            <p>Debat Senat</p>
            <a href="event.php" class="btn-lihat">Lihat</a>
        </div>
        <div class="event-card">
 ...
 <<section class="hero" style="display: flex; gap: 1rem; padding: 1rem;">
  ...
  <div style="flex: 1; max-width: 50%; background: #e0f2fe; padding: 1rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    ...
    <div style="border-radius: 6px; overflow: hidden; box-shadow: 0 1px 6px rgba(0,0,0,0.1); margin-bottom: 1rem;">
      <img src="images/cc.png" alt="Live Event STIKOM Yos Sudarso" style="width: 100%; height: auto; display: block;" />
    </div>
    <div style="font-size: 12px; max-height: 300px; overflow-y: auto; background: white; padding: 12px; border-radius: 6px; border: 1px solid #7dd3fc; color: #0369a1; line-height: 1.4; font-family: 'Inter', sans-serif;">
      ...
      <p style="margin-top: 12px; font-size: 11px; color:rgb(115, 186, 224); font-weight: 600;">
...
<div style="display: flex; gap: 2rem;">
  ...
  <!-- Kiri: Event Hari Ini -->
  <<section style="flex: 1; max-width: 60%; background:rgb(143, 13, 13); padding: 1rem; border-radius: 8px; box-shadow: 0 0 8px rgba(0,0,0,0.1);">
  <!-- Isi event hari ini -->
  ...
  <p><strong>JUDUL:</strong> WISUDA SARJANA DAN AHLI MADYA STIKOM YOS SUDARSO 21 Oktober 2024</p>
      ...
      <p style="margin-top: 12px; font-size: 11px; color:rgb(114, 188, 228); font-weight: 600;">
        #Wisuda #STIKOMYosSudarso #Purwokerto #OnlineWisuda #LiveStreaming #EventKampus
      </p>
</section>
  ...
  <div style="display: flex; flex-direction: column; max-width: 35%; gap: 1rem;">
    ...
    <!-- Social Media -->
    <div style="background-color:rgb(14, 53, 85); padding: 0.5rem 1rem; border-radius: 8px; box-shadow: 0 0 6px rgba(0,0,0,0.1); font-size: 12px;">
...
<!-- 
    ...
    <a href="belanja.php" class="fitur-float">
        <i class="fas fa-store"></i>
        <span>Belanja</span>
    </a>
    <a href="jasa1.php" class="fitur-float">
        <i class="fas fa-file-alt"></i>
        <span>Jasa</span>
    </a>
    <a href="tutor.php" class="fitur-float">
        <i class="fas fa-chalkboard-teacher"></i>
        <span>Tutor</span>
    </a>
    <a href="sewa.php" class="fitur-float">
        <i class="fas fa-box-open"></i>
        <span>Sewa</span>
    </a>
    <a href="event.php" class="fitur-float">
